...
def build_yolo_dataset(
    ...
    # We keep the official datasets. For LLVIP-RGBT 6ch input, we patch BaseDataset.load_image()
    # at runtime (see rgbt/patch_ultralytics.py), so no special dataset class is required.
